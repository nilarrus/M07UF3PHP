<html>
 ...
 <body>
 	...
 	<?php
 		# (3.2) Bucle while
 		while( $registre = mysqli_fetch_assoc($resultat) )//arrayu assiociatiu regitre["Name"] registre["CountryCode"]
          //while( $registre = mysqli_fetch_array($resultat) )//array no assiosiatiu registre["0"] registre["1"] etc
 		{
