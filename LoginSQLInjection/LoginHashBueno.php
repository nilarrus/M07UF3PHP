...
<html lang="es">
  ...
  <body>
    <div class="">
      <h4>Login</h4>
<?php
    echo "<form class='' action='LoginHashBueno.php' method='post'>
    ...
    if($_POST != null){
      ...
      $ususario = mysqli_real_escape_string($conn,$_POST['user']);
      $pasword = mysqli_real_escape_string($conn,$_POST['paswd']);
